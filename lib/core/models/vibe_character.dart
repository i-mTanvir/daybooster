...
class VibeCharacter {
  ...
  static VibeCharacter getForScore(double score) {
    if (score < 40) {
      return const VibeCharacter(
        name: 'THE HOLLOW MAN',
      ...
      return const VibeCharacter(
        ...
        color: AppColors.perfBelowTarget,
      );
    } else if (score < 90) {
      return const VibeCharacter(
